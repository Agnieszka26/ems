    ...
    <section>
      ...
      <Container>
        <div className="grid grid-cols-[2fr_1fr] items-center justify-center">
          <div className="">
            <h1 className="font-black text-5xl text-black mb-4">
              We Create Powerful <br /> Digital{' '}
              <span className="text-primary-dark">products.</span>
            </h1>
            ...
            <Button
              label={'Get Started'}
              className="bg-primary text-black shadow-lg rounded-3xl px-8  hover:bg-primary-dark"
            />
          </div>
